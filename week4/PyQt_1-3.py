...
class Lotto(QWidget):
    ...
    def ui_init(self):
        ...
        self.setWindowIcon(QIcon("lotto.png"))
        self.setGeometry(0, 0, 400, 400)
        self.show()

    def image(self):
        self.img = QLabel(self)
        self.img.setPixmap(QPixmap("lotto.png").scaled(35, 35))
        self.move(10, 10)
